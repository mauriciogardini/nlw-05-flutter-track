...
class LevelButtonWidget extends StatelessWidget {
  ...
  // LevelButtonWidget.easy() : this.label = "Easy",
  // this.color = AppColors.levelButtonEasy,
  // this.fontColor = AppColors.levelButtonTextEasy,
  // this.borderColor = AppColors.levelButtonBorderEasy;
